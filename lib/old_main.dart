  ...
  Widget build(BuildContext context) {
    return Scaffold(      
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(Icons.location_on), // Иконка слева (например, геолокация)
          onPressed: () {
        ...
        title: Text(
          'Любовь в каждой чашке', // Заголовок посередине
          style: TextStyle(
            fontSize: 20,
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.person), // Иконка справа (например, профиль)
            onPressed: () {
        ...
        backgroundColor: Colors.brown, // Прозрачный фон для соответствия дизайну
        elevation: 0, // Убираем тень для плоского стиля
      ),
      body: _pages[_selectedPage],
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: _selectedPage,
        backgroundColor: Colors.transparent, // Прозрачный фон для BottomNavigationBar
